...
export class Doctor extends Component{
    constructor(props) {
      ...
      fetchDoctor() {
        axios.get(variables.API_URL + 'Doctor', {
          ...
          .then((response) => {
            ...
            toast.success('Fetch the Doctors', {
              style: {
                background: '#5792FC',
                color: 'white'
              }
      ...
      deleteItem = (doctor_id) => {
        axios.delete(variables.API_URL + `Doctor/${doctor_id}`, {
          method: "DELETE",
          headers: {
            Authorization: "Bearer " + localStorage.getItem("token"),
          },
...
>
      <div className="card mb-6 card-sm" style={{backgroundImage: "url('https://i.pinimg.com/564x/d3/7a/c0/d37ac005bf1bbb1f9952c5ad71272533.jpg')",
  backgroundSize: 'cover',backgroundPosition: 'center',backgroundColor: '#eaf2f8', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)' }}>
        <div className="card-body">
          ...
          <button className="btn btn-primary" style={{ backgroundColor: '#1976d2' }} onClick={this.createItem}>
            Create Doctor
          </button>
        </div>
      </div>
...
<div className="container d-flex justify-content-center align-items-center">
  <div className="row">
    <div className="col-12">
      <div className="card mb-6 card-sm" style={{backgroundImage: "url('https://i.pinimg.com/564x/1b/00/de/1b00de48d8bf884e7ad61f9edc25e44a.jpg')",
  backgroundSize: 'cover',backgroundPosition: 'center',backgroundColor: '#eaf2f8', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)' }}>
        <div className="card-body">
          <h5 className="card-title" style={{ color: 'white' }}>Edit Doctor</h5>
